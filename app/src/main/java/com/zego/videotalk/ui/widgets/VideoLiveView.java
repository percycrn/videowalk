...
public class VideoLiveView extends RelativeLayout {
     ...
     * 视频显示模式.
     */
    private int mVideoViewMode = ZegoVideoViewMode.ScaleAspectFill;
    ...
    public void setLiveQuality(int quality, double videoFPS, double videoBitrate) {
        setLiveQuality(quality);
        mTvQuality.append(mResources.getString(R.string.vt_live_quality_fps_and_bitrate, videoFPS, videoBitrate));
    }
